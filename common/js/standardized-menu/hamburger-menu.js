$(document).ready(function(){
	...
	$('.collections').bind("touchstart click" , function(){
		$('#menu').trigger("close.mm");
		mflyCommands.showAddToCollection("f7e484d0e3ee4e87901ee34fe2fcbe1aproduct156167", 1, 1, 1, 1);
	})

	$('.email').bind("touchstart click" , function(){
		$('#menu').trigger("close.mm");
		mflyCommands.email("f7e484d0e3ee4e87901ee34fe2fcbe1aproduct156167");
	})
